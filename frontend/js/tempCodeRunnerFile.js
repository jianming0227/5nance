...
// 1. Replace with your actual MongoDB connection string
const mongoURI = "mongodb+srv://admin:5Nance2025@financialcluster.om5z5pu.mongodb.net/investmentDB?retryWrites=true&w=majority";  // From MongoDB Atlas
...
// 3. Define a schema for goalDB collection
...
// 4. Create a model (collection will be named `goaldb` in lowercase)
const Goal = mongoose.model('goalDB', goalSchema);

// 5. Insert a sample document
function insertGoal() {
  ...
  newGoal.save()
    .then(() => {
      console.log('🚀 New goal inserted into goalDB collection!');
